...
model = dict(
    type='RecognizerGCN',
    backbone=dict(
        type='STGCN', graph_cfg=dict(layout='human3.6m', mode='stgcn_spatial')),
    cls_head=dict(type='GCNHead', num_classes=5, in_channels=256))

dataset_type = 'PoseDataset'
ann_file = '../Data/InfAct_plus/3d/primitive/InfAct_plus.pkl'
load_from = './cpts/stgcn_8xb16-joint-u100-80e_ntu60-xsub-keypoint-3d-converted.pth'
train_pipeline = [
    dict(type='PreNormalize3D'),
    dict(type='GenSkeFeat', dataset='human3.6m', feats=['j']),
