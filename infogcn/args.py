...
def get_parser():
    ...
    parser.add_argument('--fs_size', type=int, default=5, help='')
    parser.add_argument('--cross_fold', type=int, default=None, help='')
    parser.add_argument('--infact_fold', default='posture', help='action or posture')
    parser.add_argument('--dataset',  help='data loader will be used')
    parser.add_argument('--datacase', help='data loader will be used')
    parser.add_argument('--datapath', help='data loader will be used')
    parser.add_argument('--output_dir', default='results', help='where the results are stored')
    ...
    # model
    parser.add_argument('--load_simple', type=str2bool, default=False, help='load simpler model with less encoder layers')
    parser.add_argument('--num_enc_channels', type=int, default=64, help='number of base encoding channels')
    ...
    parser.add_argument('--freeze_encoder', type=str2bool, default=False, help='freeze weights of encoder')
